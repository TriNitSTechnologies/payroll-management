                ...
                <div className="w-100 p-5 mb-5 shadow  ">
                    ...
                    <div className="d-flex w-100 h-100  ">
                        ...
                        {/* <div className="header1 m-auto ms-2 m-4 d-flex">
                            ...
                            <div className=" header1a w-50 mt-1">
                                <img src={sss} alt="this is img" className="imegee   ms-2" />
                            </div>

                            <div className="header1b w-50 ms-2  mt-1 text-center">
                        ...
                        <div className=" body1 m-auto ms-2  d-flex">
                            ...
                            <div className="body1b w-50">
                                <h5 className="   "><b> Name </b> <span className=" text-black  ps-5 ms-4  ">: {payslipData.employeeData.empName}</span></h5>
                                <h5 className="  "><b>Designation </b> <span className="text-black   ps-3  ">:  {payslipData.employeeData.designation} </span> </h5>
