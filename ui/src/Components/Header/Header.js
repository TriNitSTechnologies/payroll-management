      ...
      <div className="header-rightmenu ">
        <div className=" d-flex float-end">
          <div class="dropdown view-notification ms-4">
            <button className="rounded-circle border-light bell-notification-style" data-bs-toggle="dropdown" aria-hidden="false">
            ...
            <div className="dropdown-menu drop-menu mt-2 shadow">
              ...
              <img src={business} alt="circle" className="rounded-circle round" />
              <small className="ms-3 fs-6">Brian Johnson paid the invoice #DF65485</small>
              </div>
              ...
              <img src={business} alt="circle" className="rounded-circle round" />
              <small className="ms-3 fs-6">Marie canales has accepted your estimate #GTR458789</small>
              </div>
              </div>
              <div className="horizantal-line"></div>
              <div className="dropdown-style">
              ...
              <div className="d-flex ms-2 mt-2" >
              <img src={business} alt="circle" className="rounded-circle round" />
              <small className="ms-3 fs-6">Barbara Moore Declined the invoice #RDW026896</small>
              </div>
              </div>
              <div className="horizantal-line"></div>
              ...
              <div className="d-flex ms-2 mt-2" >
              <img src={business} alt="circle" className="rounded-circle round" />
              <small className="ms-3 fs-6">you have received a new message</small>
              </div>
              </div>
              <div className="horizantal-line"></div>
             
              <div className="dropdown-bottom text-center mt-2" >
              <small className="mb-2 "><Link to="/notifications" className="text-decoration-none text-dark">View all Notifications</Link></small>
              </div>
             </div>
             </div>
          </div>
