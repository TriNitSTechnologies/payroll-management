    ...
    return (
        <div key={data.id} className=" card border company-Carddata shadow p-4 m-4 visibledata">
            ...
            <div className="m-auto mt-2">
                <button className="btn btn-primary Editcard" onClick={() => EditCard(data)}><FaPenAlt /></button>
                <button className="btn btn-danger ms-2 Editcard" onClick={() => DeleteCard(index)} > <FaTrash /></button>
            </div>
        </div>
