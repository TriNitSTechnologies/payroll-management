...
export default function PrintAppoiement(props) {
  ...
  return (
    <>
      ...
      <div>
        <button className="btn btn-outline-dark" onClick={handlePrint}>Print</button>
      </div> 
      <div className="border-bottom p-3">
          <div className="">
            <h5 className="text-end me-3">{AppointmentData.companyName}</h5>
            <h6 className="text-end me-3">{AppointmentData.companyAddress}</h6>
        ...
        <div className="p-5">
          ...
          <div>
            <p>
              We refer to your recent interview for the position and are please
              to advise that we are offering you the position with
          ...
          <div>
            ...
            <p>
              Your position is a whole time employment with the Company and you
            ...
            <p>
              ...
              <p>
                Upon resignation/termination of employment, you will also return
                all company property, which may be in your possession.
              </p>
             
              <div>
                <ul>
                  <li>
                    If you fail, refuse or neglect to carry out and perform your
                    duties assigned to you by the company.
                  </li>
                  <li>
                    For loss of confidence in you by the company for any of the
          ...
          <div>
            <p>
              If you agree to the above terms and conditions of the appointment,
              kindly confirm your acceptance by signing and returning the
              duplicate copy of this letter for our file and records.
            </p>
          </div>
          <div>
            <div>Sincerely, </div>
